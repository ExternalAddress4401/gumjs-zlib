...
import Zstream from "../../gumjs-pako/lib/zlib/zstream.js";
import zlib_deflate from "../../gumjs-pako/lib/zlib/deflate.js";
import zlib_inflate from "../../gumjs-pako/lib/zlib/inflate.js";
import * as constants from "../../gumjs-pako/lib/zlib/constants.js";

export * from "../../gumjs-pako/lib/zlib/constants.js";
...
Zlib.prototype._process = function () {
  ...
  switch (this.mode) {
    ...
    case INFLATERAW:
      ...
      if (this.err === constants.Z_NEED_DICT && this.dictionary) {
        // Load it
        this.err = zlib_inflate.inflateSetDictionary(
          this.strm,
          this.dictionary
        );
        if (this.err === constants.Z_OK) {
          // And try to decode again
          this.err = zlib_inflate.inflate(this.strm, this.flush);
        } else if (this.err === constants.Z_DATA_ERROR) {
          // Both inflateSetDictionary() and inflate() return Z_DATA_ERROR.
          // Make it possible for After() to tell a bad dictionary from bad
          // input.
          this.err = constants.Z_NEED_DICT;
        }
      }
      while (
        this.strm.avail_in > 0 &&
        this.mode === GUNZIP &&
        this.err === constants.Z_STREAM_END &&
...
Zlib.prototype._checkError = function () {
  ...
  switch (this.err) {
    case constants.Z_OK:
    case constants.Z_BUF_ERROR:
      if (this.strm.avail_out !== 0 && this.flush === constants.Z_FINISH) {
        this._error("unexpected end of file");
        return false;
      }
      break;
    case constants.Z_STREAM_END:
      // normal statuses, not fatal
      break;
    case constants.Z_NEED_DICT:
